...
[![Croma Price Tracker](https://img.shields.io/badge/Croma%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.de/products/insights/price-tracker/croma)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.de/products/insights/price-tracker/croma)

Croma-Preisverfolgung in Echtzeit – Indiens größte Elektronik-Einzelhandelskette. Zwei Möglichkeiten für den Einstieg: eine **vollständig verwaltete** Intelligence-Plattform oder ein **benutzerdefinierter Scraper**, erstellt mit Bright Data's AI Scraper Builder.

---

## Option 1: Bright Insights – KI-gestützte Preisverfolgung (Empfohlen)

**[Bright Insights](https://brightdata.de/products/insights/price-tracker/croma)** ist Bright Data's vollständig verwaltete Plattform für Retail Intelligence. Keine Scraper zu erstellen, keine Infrastruktur zu warten – nur strukturierte, analysebereite Preisdaten, die an Dashboards, Data Feeds oder Ihre BI-Tools geliefert werden.
...
- ✅ **Preisnachlässe bei Elektronikprodukten überwachen** und Verkaufsaktionen auf Croma verfolgen
- ✅ **Bestandsverfügbarkeit verfolgen** für schwer auffindbare Artikel
...
> **Ab $250/Monat – [Individuelles Angebot anfordern →](https://brightdata.de/products/insights/price-tracker/croma)**

---

## Option 2: Erstellen Sie Ihren eigenen Croma-Scraper

Keine vorgefertigte Croma-Scraper-API? Kein Problem. Bright Data's **AI Scraper Builder** generiert in nur wenigen Klicks einen benutzerdefinierten Croma-Scraper — ganz ohne Programmierung.

### Erstellen Sie Ihren Croma-Scraper in wenigen Minuten

**[Öffnen Sie den Croma AI Scraper Builder →](https://brightdata.de/products/web-scraper/croma)**
...
- Eine **Web Scraper ID** für Croma (aus dem obigen Build-Schritt)
...
1. **Dieses repository klonen**
   ...
   ```bash
   git clone https://github.com/bright-data-de/croma-price-tracker.git
...
3. **Zugangsdaten konfigurieren**
   ...
   > **Ihre Web Scraper ID**
   > Fügen Sie die Web Scraper ID aus Ihrem [AI Scraper Builder dashboard](https://brightdata.de/products/web-scraper/croma)
...
Sobald Ihr Croma-Scraper erstellt und Ihre Web Scraper ID in `.env` konfiguriert ist, funktioniert die Python-Schnittstelle auf die gleiche Weise:

### 1. Bestimmte Produkte per URL verfolgen

Übergeben Sie eine Liste von Croma-Produkt-URLs, um strukturierte Preisdaten abzurufen:
...
Sammeln Sie alle Produkte von einer Croma-Kategorieseite:
...
- 🌟 [Croma Price Tracker - Bright Insights (Managed)](https://brightdata.de/products/insights/price-tracker/croma)
- 🏗️ [Build a Croma Scraper](https://brightdata.de/products/web-scraper/croma)
